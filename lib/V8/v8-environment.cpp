...
static bool canExpose(v8::Isolate* isolate, v8::Local<v8::Name> property) {
  ...
  arangodb::V8PlatformFeature* v8platform =
      arangodb::application_features::ApplicationServer::getFeature<arangodb::V8PlatformFeature>(
          "V8Platform");
  TRI_ASSERT(v8platform != nullptr);
  return v8platform->shouldExposeEnvironmentVariable(utf8String);
}
