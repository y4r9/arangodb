...
void RocksDBGeoV8Functions::registerResources() {
  ...
  TRI_AddGlobalFunctionVocbase(isolate,
      TRI_V8_ASCII_STRING(isolate, "STONES_TEST"),
      JS_StonesTest, true);

  TRI_AddGlobalFunctionVocbase(isolate,
      TRI_V8_ASCII_STRING(isolate, "STONES_BENCHMARK_SETUP"),
      JS_StonesBenchmarkSetup, true);

  TRI_AddGlobalFunctionVocbase(isolate,
      TRI_V8_ASCII_STRING(isolate, "STONES_BENCHMARK"),
      JS_StonesBenchmark, true);

  TRI_AddGlobalFunctionVocbase(isolate,
      TRI_V8_ASCII_STRING(isolate, "STONES_BENCHMARK_SHUTDOWN"),
